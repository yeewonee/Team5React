...
import { createSetAuthTokenAction, createSetUidAction, createSetRoleAction, createSetNameAction } from "redux/auth-reducer";
...
store.dispatch(createSetNameAction(sessionStorage.getItem("name") || ""));
